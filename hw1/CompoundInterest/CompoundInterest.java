...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
        ...
        double answer = presentValue * (Math.pow((1 + rate/100), CompoundInterest.numYears(targetYear)));
        return answer;
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double totalinflation = Math.pow((1 - inflationRate/100), (targetYear - THIS_YEAR));
        return CompoundInterest.futureValue(presentValue, rate, targetYear) * totalinflation;
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        //using financial mathematic calculting interest
        double nexp = Math.pow((1+rate/100), (CompoundInterest.numYears(targetYear)+1));
        double dde = rate / 100;
        return perYear * (nexp - 1)/ dde;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        return CompoundInterest.totalSavings(perYear, targetYear,rate)* (Math.pow((100-inflationRate)/100, CompoundInterest.numYears(targetYear)))
                ;
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = CompoundInterest.futureValue(1, 10, 2059); // replace 0 with your code
        double realDollarValue = CompoundInterest.futureValueReal(1, 10, 2059, 3);    // replace 0 with your code
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = CompoundInterest.totalSavings(10000, 2059, 10); // replace 0 with your code
        double realSavings = CompoundInterest.totalSavingsReal(10000, 2059, 10, 3);    // replace 0 with your code
        // Do not change anything in this method below this line
