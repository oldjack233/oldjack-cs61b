 ...
 *  @author
 */
public class PermutationTestlab {
    ...
    public void checkinvertChar() {
        ...
        String to = "ARJEFDSHI";
        Permutation perm = getNewPermutation("(JAR) (DF) (ISH)",
                getNewAlphabet(from));
        ...
        String from1 = "ABCD";
        String to1 = "BCDA";
        Permutation perm1 = getNewPermutation("(" + from1 + ")",
                getNewAlphabet(from1));
