...
class BoardWidget extends Pad {
    ...
    private void mouseReleased(Square s) {
        ...
        _mouseAction.add(s);
        Square start = _mouseAction.get(0);
        Square end = _mouseAction.get(1);
        _commands.add(start.toString() + "-" + end.toString());

        ALL_SQUARES[start.index()] = end;
        ALL_SQUARES[end.index()] = start;
    ...
    /**array containing press and release actions. */
    private ArrayList<Square> _mouseAction;
