...
public class IntDListTest {
    ...
    public void testInsertAtIndex() {
        ...
        assertEquals("First element after inserting 5 should be 5", 5, d.get(0));
        assertEquals("First element after inserting 5 should be 5", 5, d.get(-1));
        ...
        assertEquals("Last element after insert should be 20", 20, d.get(-1));
        assertEquals("Second to last element after insert should be 15", 15, d.get(-2));
        assertEquals("Third to last element after insert should be 10", 10, d.get(-3));
        ...
        assertEquals("Last element after insert should be 20", 20, d.get(-1));
        assertEquals("Second to last element after insert should be 15", 15, d.get(-2));
        assertEquals("Third to last element after insert should be 13", 13, d.get(-3));
        assertEquals("Fourth to last element after insert should be 10", 10, d.get(-4));
        ...
        assertEquals("Last element after insert should be 25", 25, d.get(-1));
        assertEquals("Second to last element after insert should be 20", 20, d.get(-2));
        assertEquals("Third to last element after insert should be 15", 15, d.get(-3));
        assertEquals("Fourth to last element after insert should be 10", 10, d.get(-4));
        assertEquals("Fifth to last element after insert should be 5", 5, d.get(-5));
        ...
        assertEquals("Second element after insert should be 10", 10, d.get(1));
        assertEquals("Third element after insert should be 15", 15, d.get(2));
        assertEquals("Fourth element after insert should be 17", 17, d.get(3));
        assertEquals("Fifth element after insert should be 20", 20, d.get(4));
        assertEquals("Last element after insert should be 20", 20, d.get(-1));
        assertEquals("Second to last element after insert should be 17", 17, d.get(-2));
        assertEquals("Third to last element after insert should be 15", 15, d.get(-3));
        assertEquals("Fourth to last element after insert should be 10", 10, d.get(-4));
        assertEquals("Fifth to last element after insert should be 5", 5, d.get(-5));
    ...
    public void testDeleteAtIndex() {
        ...
        d = new IntDList(5);
        assertEquals(".deleteAtIndex(-1) value (5)", 5, d.deleteAtIndex(-1));
        assertEquals("Size after delete should be 0", 0, d.size());
        assertNull("Front should point to null", d._front);
        assertNull("Back should point to null", d._back);
        ...
        assertEquals("Last element after delete should be 25", 25, d.get(-1));
        assertEquals("Second to last element after delete should be 20", 20, d.get(-2));
        assertEquals("Third to last element after delete should be 10", 10, d.get(-3));
        assertEquals("Fourth to last element after delete should be 5", 5, d.get(-4));
        ...
        assertEquals("Last element after delete should be 20", 20, d.get(-1));
        assertEquals("Second to last element after delete should be 15", 15, d.get(-2));
        assertEquals("Third to last element after delete should be 10", 10, d.get(-3));
        assertEquals("Fourth to last element after delete should be 5", 5, d.get(-4));

        d = new IntDList(5, 10);
        assertEquals(".deleteAtIndex(-1) value (10)", 10, d.deleteAtIndex(-1));
        assertEquals("Size after delete should be 1", 1, d.size());
        assertEquals(".getFront() should return 5", 5, d.getFront());
        assertEquals(".getBack() should return 5", 5, d.getBack());
        assertEquals("First element after delete should be (5)", 5, d.get(0));
        assertEquals("Last element after delete should be (5)", 5, d.get(-1));

        d = new IntDList(5, 10, 15, 20, 25);
        assertEquals(".deleteAtIndex(-2) value (20)", 20, d.deleteAtIndex(-2));
        assertEquals("Size after delete should be 4", 4, d.size());
        assertEquals(".getFront() should return 5", 5, d.getFront());
        assertEquals(".getBack() should return 25", 25, d.getBack());
        assertEquals("First element after delete should be (5)", 5, d.get(0));
        ...
        d = new IntDList(5, 10, 15, 20, 25);
        assertEquals(".deleteAtIndex(-5) value (5)", 5, d.deleteAtIndex(-5));
        assertEquals("Size after delete should be 4", 4, d.size());
        assertEquals(".getFront() should return 10", 10, d.getFront());
        assertEquals(".getBack() should return 25", 25, d.getBack());
        assertEquals("First element after delete should be (10)", 10, d.get(0));
        assertEquals("Second element after delete should be (15)", 15, d.get(1));
        assertEquals("Third element after delete should be (20)", 20, d.get(2));
        assertEquals("Fourth element after delete should be (25)", 25, d.get(3));
        assertEquals("Last element after delete should be 25", 25, d.get(-1));
        assertEquals("Second to last element after delete should be 20", 20, d.get(-2));
        assertEquals("Third to last element after delete should be 15", 15, d.get(-3));
        assertEquals("Fourth to last element after delete should be 10", 10, d.get(-4));
    }
